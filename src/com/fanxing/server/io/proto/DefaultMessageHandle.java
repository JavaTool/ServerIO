...
public class DefaultMessageHandle implements MessageHandle, Processors {
	...
	@Override
	public void handle(byte[] receiveDatas, String ip, String receiveMessageId, String sessionId, ISender sender) throws Exception {
		Response response;
		switch (MessageId.valueOf(receiveMessageId)) {
		case MICS_GainSupply : 
			if (getLegionProcessor() != null) {
				Request request = new Request(ip, receiveMessageId, sessionId, sender);
				GainSupplyResponse resp = new GainSupplyResponse(request);
				getLegionProcessor().processGainSupply(request, resp);
				response = resp;
			} else {
				response = createNoProcessorResponse(new RedirectRequest(ip, receiveMessageId, sessionId, receiveDatas, sender));
			}
			break;
		case MICS_RemoveMember : 
			if (getLegionProcessor() != null) {
				CS_RemoveMember cS_RemoveMember = CS_RemoveMember.parseFrom(receiveDatas);
				RemoveMemberRequest removeMemberRequest = new RemoveMemberRequest(ip, receiveMessageId, sessionId, sender, cS_RemoveMember);
		...
		case MICS_ReplyApplyJoinLegion : 
			if (getLegionProcessor() != null) {
				CS_ReplyApplyJoinLegion cS_ReplyApplyJoinLegion = CS_ReplyApplyJoinLegion.parseFrom(receiveDatas);
				ReplyApplyJoinLegionRequest replyApplyJoinLegionRequest = new ReplyApplyJoinLegionRequest(ip, receiveMessageId, sessionId, sender, cS_ReplyApplyJoinLegion);
		...
		case MICS_AccountGetRoleList : 
			if (getRoleProcessor() != null) {
				...
				AccountGetRoleListRequest accountGetRoleListRequest = new AccountGetRoleListRequest(ip, receiveMessageId, sessionId, sender, cS_AccountGetRoleList);
		...
		case MICS_TankStrengthen : 
			if (getTankProcessor() != null) {
				...
				TankStrengthenRequest tankStrengthenRequest = new TankStrengthenRequest(ip, receiveMessageId, sessionId, sender, cS_TankStrengthen);
		...
		case MICS_GetLegionMemberInfoList : 
			if (getLegionProcessor() != null) {
				CS_GetLegionMemberInfoList cS_GetLegionMemberInfoList = CS_GetLegionMemberInfoList.parseFrom(receiveDatas);
				GetLegionMemberInfoListRequest getLegionMemberInfoListRequest = new GetLegionMemberInfoListRequest(ip, receiveMessageId, sessionId, sender, cS_GetLegionMemberInfoList);
		...
		case MICS_CheckVersion : 
			if (getCommonProcessor() != null) {
				...
				CheckVersionRequest checkVersionRequest = new CheckVersionRequest(ip, receiveMessageId, sessionId, sender, cS_CheckVersion);
		...
		case MICS_TankUpgrade : 
			if (getTankProcessor() != null) {
				...
				TankUpgradeRequest tankUpgradeRequest = new TankUpgradeRequest(ip, receiveMessageId, sessionId, sender, cS_TankUpgrade);
		...
		case MICS_ServerStatus : 
			if (getCommonProcessor() != null) {
				...
				ServerStatusRequest serverStatusRequest = new ServerStatusRequest(ip, receiveMessageId, sessionId, sender, cS_ServerStatus);
		...
		case MICS_DonateGoods : 
			if (getLegionProcessor() != null) {
				CS_DonateGoods cS_DonateGoods = CS_DonateGoods.parseFrom(receiveDatas);
				DonateGoodsRequest donateGoodsRequest = new DonateGoodsRequest(ip, receiveMessageId, sessionId, sender, cS_DonateGoods);
		...
		case MICS_TransferLegion : 
			if (getLegionProcessor() != null) {
				CS_TransferLegion cS_TransferLegion = CS_TransferLegion.parseFrom(receiveDatas);
				TransferLegionRequest transferLegionRequest = new TransferLegionRequest(ip, receiveMessageId, sessionId, sender, cS_TransferLegion);
		...
		case MICS_ApplyJoinLegion : 
			if (getLegionProcessor() != null) {
				CS_ApplyJoinLegion cS_ApplyJoinLegion = CS_ApplyJoinLegion.parseFrom(receiveDatas);
				ApplyJoinLegionRequest applyJoinLegionRequest = new ApplyJoinLegionRequest(ip, receiveMessageId, sessionId, sender, cS_ApplyJoinLegion);
		...
		case MICS_BuyLegionGoods : 
			if (getLegionProcessor() != null) {
				CS_BuyLegionGoods cS_BuyLegionGoods = CS_BuyLegionGoods.parseFrom(receiveDatas);
				BuyLegionGoodsRequest buyLegionGoodsRequest = new BuyLegionGoodsRequest(ip, receiveMessageId, sessionId, sender, cS_BuyLegionGoods);
		...
		case MICS_NewRoleInfo : 
			if (getRoleProcessor() != null) {
				...
				NewRoleInfoRequest newRoleInfoRequest = new NewRoleInfoRequest(ip, receiveMessageId, sessionId, sender, cS_NewRoleInfo);
		...
		case MICS_HttpCheck : 
			if (getCommonProcessor() != null) {
				...
				HttpCheckRequest httpCheckRequest = new HttpCheckRequest(ip, receiveMessageId, sessionId, sender, cS_HttpCheck);
		...
		case MICS_Test1 : 
			if (getTestProcessor() != null) {
				...
				Test1Request test1Request = new Test1Request(ip, receiveMessageId, sessionId, sender, cS_Test1);
		...
		case MICS_RoleInfo : 
			if (getRoleProcessor() != null) {
				...
				RoleInfoRequest roleInfoRequest = new RoleInfoRequest(ip, receiveMessageId, sessionId, sender, cS_RoleInfo);
		...
		case MICS_GetLegionInfo : 
			if (getLegionProcessor() != null) {
				CS_GetLegionInfo cS_GetLegionInfo = CS_GetLegionInfo.parseFrom(receiveDatas);
				GetLegionInfoRequest getLegionInfoRequest = new GetLegionInfoRequest(ip, receiveMessageId, sessionId, sender, cS_GetLegionInfo);
		...
		case MIVO_ServerInfo : 
			if (getCommonProcessor() != null) {
				...
				ServerInfoRequest serverInfoRequest = new ServerInfoRequest(ip, receiveMessageId, sessionId, sender, vO_ServerInfo);
		...
		case MICS_AccountRegister : 
			if (getAccountProcessor() != null) {
				...
				AccountRegisterRequest accountRegisterRequest = new AccountRegisterRequest(ip, receiveMessageId, sessionId, sender, cS_AccountRegister);
		...
		case MICS_GetServerList : 
			if (getCommonProcessor() != null) {
				...
				GetServerListRequest getServerListRequest = new GetServerListRequest(ip, receiveMessageId, sessionId, sender, cS_GetServerList);
		...
		case MICS_Reconnect : 
			if (getCommonProcessor() != null) {
				...
				ReconnectRequest reconnectRequest = new ReconnectRequest(ip, receiveMessageId, sessionId, sender, cS_Reconnect);
		...
		case MICS_AccountLogin : 
			if (getAccountProcessor() != null) {
				...
				AccountLoginRequest accountLoginRequest = new AccountLoginRequest(ip, receiveMessageId, sessionId, sender, cS_AccountLogin);
		...
		case MICS_SendChatMessage : 
			if (getLegionProcessor() != null) {
				CS_SendChatMessage cS_SendChatMessage = CS_SendChatMessage.parseFrom(receiveDatas);
				SendChatMessageRequest sendChatMessageRequest = new SendChatMessageRequest(ip, receiveMessageId, sessionId, sender, cS_SendChatMessage);
		...
		case MICS_SelectServer : 
			if (getCommonProcessor() != null) {
				...
				SelectServerRequest selectServerRequest = new SelectServerRequest(ip, receiveMessageId, sessionId, sender, cS_SelectServer);
		...
		case MICS_GetLegionLog : 
			if (getLegionProcessor() != null) {
				CS_GetLegionLog cS_GetLegionLog = CS_GetLegionLog.parseFrom(receiveDatas);
				GetLegionLogRequest getLegionLogRequest = new GetLegionLogRequest(ip, receiveMessageId, sessionId, sender, cS_GetLegionLog);
		...
		case MICS_AccountAuthenticate : 
			if (getRoleProcessor() != null) {
				...
				AccountAuthenticateRequest accountAuthenticateRequest = new AccountAuthenticateRequest(ip, receiveMessageId, sessionId, sender, cS_AccountAuthenticate);
		...
		case MICS_ReplyInvitation : 
			if (getLegionProcessor() != null) {
				CS_ReplyInvitation cS_ReplyInvitation = CS_ReplyInvitation.parseFrom(receiveDatas);
				ReplyInvitationRequest replyInvitationRequest = new ReplyInvitationRequest(ip, receiveMessageId, sessionId, sender, cS_ReplyInvitation);
		...
		case MICS_TankUpgradesStar : 
			if (getTankProcessor() != null) {
				...
				TankUpgradesStarRequest tankUpgradesStarRequest = new TankUpgradesStarRequest(ip, receiveMessageId, sessionId, sender, cS_TankUpgradesStar);
		...
		case MICS_CreateRole : 
			if (getRoleProcessor() != null) {
				...
				CreateRoleRequest createRoleRequest = new CreateRoleRequest(ip, receiveMessageId, sessionId, sender, cS_CreateRole);
		...
		case MICS_TcpConnect : 
			if (getTcpProcessor() != null) {
				...
				TcpConnectRequest tcpConnectRequest = new TcpConnectRequest(ip, receiveMessageId, sessionId, sender, cS_TcpConnect);
		...
		case MICS_Disconnect : 
			if (getAccountProcessor() != null) {
				...
				DisconnectRequest disconnectRequest = new DisconnectRequest(ip, receiveMessageId, sessionId, sender, cS_Disconnect);
		...
		case MICS_InviteJoinLegion : 
			if (getLegionProcessor() != null) {
				CS_InviteJoinLegion cS_InviteJoinLegion = CS_InviteJoinLegion.parseFrom(receiveDatas);
				InviteJoinLegionRequest inviteJoinLegionRequest = new InviteJoinLegionRequest(ip, receiveMessageId, sessionId, sender, cS_InviteJoinLegion);
		...
		case MICS_TankChangeEquipment : 
			if (getTankProcessor() != null) {
				CS_TankChangeEquipment cS_TankChangeEquipment = CS_TankChangeEquipment.parseFrom(receiveDatas);
				TankChangeEquipmentRequest tankChangeEquipmentRequest = new TankChangeEquipmentRequest(ip, receiveMessageId, sessionId, sender, cS_TankChangeEquipment);
		...
		case MICS_PermissionManage : 
			if (getLegionProcessor() != null) {
				CS_PermissionManage cS_PermissionManage = CS_PermissionManage.parseFrom(receiveDatas);
				PermissionManageRequest permissionManageRequest = new PermissionManageRequest(ip, receiveMessageId, sessionId, sender, cS_PermissionManage);
	...
	@Override
	public LegionProcessor getLegionProcessor() {
