 ...
 * @author fuhuiyuan
 */
public class InviteJoinLegionResponse extends Response {

	private SC_InviteJoinLegion.Builder builder = SC_InviteJoinLegion.newBuilder();

	public InviteJoinLegionResponse(Request request) {
		super(request);
	}

	public SC_InviteJoinLegion getSC_InviteJoinLegion() {
