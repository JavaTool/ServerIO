 ...
 * @author fuhuiyuan
 */
public class RecommendLegionListResponse extends Response {

	private SC_RecommendLegionList.Builder builder = SC_RecommendLegionList.newBuilder();

	public RecommendLegionListResponse(Request request) {
		super(request);
	}

	public SC_RecommendLegionList getSC_RecommendLegionList() {
	 ...
	 * 			军团信息
	 */
	public void setLegionInfos(Iterable<VO_LegionInfo> LegionInfos) {
		builder.addAllLegionInfos(LegionInfos);
	}
