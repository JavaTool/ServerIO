 ...
 * @author fuhuiyuan
 */
public class ReplyInvitationResponse extends Response {

	private SC_ReplyInvitation.Builder builder = SC_ReplyInvitation.newBuilder();

	public ReplyInvitationResponse(Request request) {
		super(request);
	}

	public SC_ReplyInvitation getSC_ReplyInvitation() {
