 ...
 * @author fuhuiyuan
 */
public class PermissionManageResponse extends Response {

	private SC_PermissionManage.Builder builder = SC_PermissionManage.newBuilder();

	public PermissionManageResponse(Request request) {
		super(request);
	}

	public SC_PermissionManage getSC_PermissionManage() {
