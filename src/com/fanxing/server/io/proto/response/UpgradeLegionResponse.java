 ...
 * @author fuhuiyuan
 */
public class UpgradeLegionResponse extends Response {

	private SC_UpgradeLegion.Builder builder = SC_UpgradeLegion.newBuilder();

	public UpgradeLegionResponse(Request request) {
		super(request);
	}

	public SC_UpgradeLegion getSC_UpgradeLegion() {
