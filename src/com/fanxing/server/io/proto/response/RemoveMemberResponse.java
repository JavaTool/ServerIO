...
public class RemoveMemberResponse extends Response {
	...
	private SC_RemoveMember.Builder builder = SC_RemoveMember.newBuilder();

	public RemoveMemberResponse(Request request) {
		super(request);
	}

	public SC_RemoveMember getSC_RemoveMember() {
