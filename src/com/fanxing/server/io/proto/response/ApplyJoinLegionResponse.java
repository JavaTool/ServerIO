 ...
 * @author fuhuiyuan
 */
public class ApplyJoinLegionResponse extends Response {

	private SC_ApplyJoinLegion.Builder builder = SC_ApplyJoinLegion.newBuilder();

	public ApplyJoinLegionResponse(Request request) {
		super(request);
	}

	public SC_ApplyJoinLegion getSC_ApplyJoinLegion() {
