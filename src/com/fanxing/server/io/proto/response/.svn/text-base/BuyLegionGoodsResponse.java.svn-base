 ...
 * @author fuhuiyuan
 */
public class BuyLegionGoodsResponse extends Response {

	private SC_BuyLegionGoods.Builder builder = SC_BuyLegionGoods.newBuilder();

	public BuyLegionGoodsResponse(Request request) {
		super(request);
	}

	public SC_BuyLegionGoods getSC_BuyLegionGoods() {
