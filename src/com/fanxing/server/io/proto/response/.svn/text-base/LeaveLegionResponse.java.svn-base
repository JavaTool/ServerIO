 ...
 * @author fuhuiyuan
 */
public class LeaveLegionResponse extends Response {

	private SC_LeaveLegion.Builder builder = SC_LeaveLegion.newBuilder();

	public LeaveLegionResponse(Request request) {
		super(request);
	}

	public SC_LeaveLegion getSC_LeaveLegion() {
