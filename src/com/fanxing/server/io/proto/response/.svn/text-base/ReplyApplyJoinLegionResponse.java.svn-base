 ...
 * @author fuhuiyuan
 */
public class ReplyApplyJoinLegionResponse extends Response {

	private SC_ReplyApplyJoinLegion.Builder builder = SC_ReplyApplyJoinLegion.newBuilder();

	public ReplyApplyJoinLegionResponse(Request request) {
		super(request);
	}

	public SC_ReplyApplyJoinLegion getSC_ReplyApplyJoinLegion() {
