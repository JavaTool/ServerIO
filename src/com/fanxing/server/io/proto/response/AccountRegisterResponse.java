 ...
 * @author fuhuiyuan
 */
public class AccountRegisterResponse extends Response {

	private SC_AccountRegister.Builder builder = SC_AccountRegister.newBuilder();

	public AccountRegisterResponse(Request request) {
		super(request);
	}

	public SC_AccountRegister getSC_AccountRegister() {
